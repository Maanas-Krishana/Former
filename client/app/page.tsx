  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] dark:bg-zinc-950 text-gray-900 dark:text-gray-100 selection:bg-indigo-100 dark:selection:bg-indigo-950 selection:text-indigo-900 dark:selection:text-indigo-200 overflow-x-hidden relative transition-colors duration-200">
      ...
      <section className="max-w-7xl mx-auto px-6 sm:px-8 pt-16 pb-24 text-center relative z-10 flex flex-col items-center">
        <div className="inline-flex items-center space-x-2 bg-indigo-50 border border-indigo-100/80 rounded-full px-4 py-1.5 mb-8 animate-fade-in shadow-sm">
          <Sparkles className="w-4 h-4 text-indigo-600" />
          <span className="text-xs font-semibold text-indigo-700 uppercase tracking-wider">Form creation, reinvented with AI</span>
        </div>

        <h1 className="text-5xl sm:text-7xl font-extrabold tracking-tight text-gray-900 max-w-4xl leading-[1.1] mb-6">
          Build beautiful forms in <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">seconds</span>.
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 mb-16 w-full max-w-md">
          <Button onClick={() => router.push('/signup')} className="w-full sm:w-auto flex-1 bg-indigo-600 hover:bg-indigo-700 text-white text-base font-semibold py-6 rounded-2xl shadow-lg shadow-indigo-100 transition-all hover:translate-y-[-1px] group">
            Start Building Free
            <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
          </Button>
          <Button variant="outline" onClick={() => router.push('/login')} className="w-full sm:w-auto border-gray-300 hover:bg-gray-50 text-base font-semibold py-6 rounded-2xl bg-white px-8">
            Manage Forms
          </Button>
        </div>

        {/* Dashboard Mockup */}
        <div className="w-full max-w-5xl rounded-3xl border border-gray-200/80 bg-white p-4 shadow-2xl relative group overflow-hidden">
          ...
          <div className="rounded-2xl border border-gray-100 overflow-hidden bg-gray-50 aspect-[16/10] relative shadow-inner">
            <div className="absolute top-0 inset-x-0 h-12 bg-white border-b flex items-center px-4 space-x-2">
            ...
            <div className="pt-16 p-8 text-left space-y-6">
              <div className="flex items-center justify-between border-b pb-4">
                <div>
                  <h4 className="text-xl font-bold text-gray-900">My Forms</h4>
                  <p className="text-xs text-gray-400">Manage and view responses for your forms.</p>
                </div>
                <div className="w-32 h-8 bg-indigo-100 rounded-lg animate-pulse" />
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-white rounded-xl border p-5 shadow-sm space-y-4">
                  <div className="flex justify-between">
                    <div className="w-10 h-10 bg-indigo-50 rounded-lg flex items-center justify-center text-indigo-600"><FileText className="w-5 h-5" /></div>
                    <div className="w-16 h-6 bg-gray-100 rounded-full" />
                  </div>
                  <div className="space-y-2">
                    <div className="w-48 h-4 bg-gray-900 rounded" />
                ...
                <div className="bg-white rounded-xl border p-5 shadow-sm space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="w-40 h-4 bg-gray-900 rounded" />
      ...
      {/* Feature Section */}
      <section id="features" className="max-w-7xl mx-auto px-6 sm:px-8 py-20 border-t border-gray-100 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-4">Features built for creators</h2>
          <p className="text-gray-500 text-lg">Everything you need to gather responses, analyze data, and build seamless client experiences.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white border rounded-2xl p-8 hover:shadow-lg transition-shadow space-y-4">
            <div className="w-12 h-12 bg-indigo-50 text-indigo-600 rounded-xl flex items-center justify-center shadow-sm">
              <Sparkles className="w-6 h-6" />
            </div>
            <h3 className="text-lg font-bold text-gray-900">AI Form Generation</h3>
          ...
          <div className="bg-white border rounded-2xl p-8 hover:shadow-lg transition-shadow space-y-4">
            ...
            <h3 className="text-lg font-bold text-gray-900">Real-Time Insights</h3>
            <p className="text-gray-500 text-sm leading-relaxed">
          ...
          <div className="bg-white border rounded-2xl p-8 hover:shadow-lg transition-shadow space-y-4">
            ...
            <h3 className="text-lg font-bold text-gray-900">Instant Duplication</h3>
            <p className="text-gray-500 text-sm leading-relaxed">
      ...
      <footer className="bg-white border-t py-12 relative z-10">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="flex items-center space-x-2">
            ...
            <span className="font-bold text-indigo-600 text-lg">Former</span>
          </div>
          <p className="text-xs text-gray-400">© 2026 Former. Proudly made in India.</p>
        </div>
      </footer>
    </div>
  );
